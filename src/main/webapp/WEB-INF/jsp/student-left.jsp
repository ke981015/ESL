                    ...
                    <div class="row">
                        <nav class="col-sm-3">
                            <ul class="nav nav-pills nav-stacked" data-spy="affix" data-offset-top="205">
                                ...
                                <li><a href="${contextPath}/appointments.htm?action=request" target="right">Schedule Appointment</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
            ...
            <div class="panel-body">
                <div class="container">
                    <div class="row">
                        <nav class="col-sm-3">
                            <ul class="nav nav-pills nav-stacked" data-spy="affix" data-offset-top="205">
                                 <li><a href="${contextPath}/information.htm?action=view" target="right">View Information</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
